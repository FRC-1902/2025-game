...
public class CoralDetectorSim implements CoralDetector {
    ...
    private double fovDegrees = 82; // TODO: FIND FOV FOR ARDUCAM
    ...
    private Pose2d getCoralPoseBasic(Pose2d robotPose) {
        Pose2d coralPose = Robot.isBlue() ? MapleSimSetup.blueHPCoralPose : MapleSimSetup.redHPCoralPose;
     ...
     */
    public Pose2d getCoralPoseMapleSim(Pose2d robotPose) {
