...
import frc.robot.subsystems.vision.BillinearInterpolator;

/** Add your docs here. */
public class ObjectDetection {

  private static Pose2d notePos;
  private static BillinearInterpolator pixelLookupInterpolator;

  private ObjectDetection() {
    pixelLookupInterpolator = new BillinearInterpolator(VisionConstants.noteDetectionLookupTable);
  }
