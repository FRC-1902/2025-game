...
public class AbsoluteDriveAdv extends Command
{
   ...
   */
  public AbsoluteDriveAdv( Swerve swerve, DoubleSupplier vX, DoubleSupplier vY, DoubleSupplier headingAdjust, BooleanSupplier lookAway, BooleanSupplier lookTowards, BooleanSupplier lookLeft, BooleanSupplier lookRight) {
    this.swerve = swerve;
    this.vX = vX;
    this.vY = vY;
  ...
  public void execute()
  {
    ...
    translation = SwerveMath.limitVelocity(
      translation, swerve.getFieldVelocity(), 
      swerve.getPose(),
    ...
    {
      resetHeading = true;
      swerve.drive(translation, (Constants.Controllers.TURN_CONSTANT * -headingAdjust.getAsDouble()), true);
    } else
    {
